...
type GetTestReponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
}

func (x *GetTestReponse) Reset() {
	*x = GetTestReponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *GetTestReponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetTestReponse) ProtoMessage() {}

func (x *GetTestReponse) ProtoReflect() protoreflect.Message {
	mi := &file_order_order_proto_msgTypes[6]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetTestReponse.ProtoReflect.Descriptor instead.
func (*GetTestReponse) Descriptor() ([]byte, []int) {
...
var file_order_order_proto_rawDesc = []byte{
	...
	0x74, 0x65, 0x6d, 0x73, 0x22, 0x10, 0x0a, 0x0e, 0x47, 0x65, 0x74, 0x54, 0x65, 0x73, 0x74, 0x52,
	0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x22, 0x10, 0x0a, 0x0e, 0x47, 0x65, 0x74, 0x54, 0x65, 0x73,
	0x74, 0x52, 0x65, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x32, 0x9b, 0x01, 0x0a, 0x05, 0x4f, 0x72, 0x64,
	...
	0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x12, 0x2d, 0x0a, 0x07, 0x47, 0x65, 0x74, 0x54, 0x65,
	0x73, 0x74, 0x12, 0x0f, 0x2e, 0x47, 0x65, 0x74, 0x54, 0x65, 0x73, 0x74, 0x52, 0x65, 0x71, 0x75,
	0x65, 0x73, 0x74, 0x1a, 0x0f, 0x2e, 0x47, 0x65, 0x74, 0x54, 0x65, 0x73, 0x74, 0x52, 0x65, 0x70,
	0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x42, 0x30, 0x5a, 0x2e, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62,
	0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x6e, 0x69, 0x63, 0x6f, 0x2d, 0x70, 0x68, 0x69, 0x6c, 0x2f, 0x6d,
...
var file_order_order_proto_goTypes = []any{
	...
	(*GetTestRequest)(nil),      // 5: GetTestRequest
	(*GetTestReponse)(nil),      // 6: GetTestReponse
}
var file_order_order_proto_depIdxs = []int32{
	...
	5, // 4: Order.GetTest:input_type -> GetTestRequest
	2, // 5: Order.Create:output_type -> CreateOrderResponse
	4, // 6: Order.Get:output_type -> GetOrderResponse
	6, // 7: Order.GetTest:output_type -> GetTestReponse
